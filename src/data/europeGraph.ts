...
export const EUROPE_GRAPH: Record<CountryId, GraphNode> = {
    ...
    CY: { id: "CY", name: "Cyprus", neighbors: [], isIsland: true },
    ...
    GR: { id: "GR", name: "Greece", neighbors: [{ target: "AL", type: "LAND" }, { target: "MK", type: "LAND" }, { target: "BG", type: "LAND" }, { target: "TR", type: "LAND" }, { target: "IT", type: "SEA" }, { target: "MT", type: "SEA" }] },
    ...
    IS: { id: "IS", name: "Iceland", neighbors: [], isIsland: true },
    IE: { id: "IE", name: "Ireland", neighbors: [{ target: "GB", type: "LAND" }] },
    IT: { id: "IT", name: "Italy", neighbors: [{ target: "FR", type: "LAND" }, { target: "CH", type: "LAND" }, { target: "AT", type: "LAND" }, { target: "SI", type: "LAND" }, { target: "SM", type: "LAND" }, { target: "VA", type: "LAND" }, { target: "GR", type: "SEA" }, { target: "MT", type: "SEA" }] },
    KZ: { id: "KZ", name: "Kazakhstan", neighbors: [] }, // Usually not in standard map, keep empty
    ...
    NO: { id: "NO", name: "Norway", neighbors: [{ target: "SE", type: "LAND" }, { target: "FI", type: "LAND" }, { target: "RU", type: "LAND" }] },
    ...
    TR: { id: "TR", name: "Turkey", neighbors: [{ target: "GR", type: "LAND" }, { target: "BG", type: "LAND" }, { target: "GE", type: "LAND" }, { target: "AM", type: "LAND" }] },
    ...
    GB: { id: "GB", name: "United Kingdom", neighbors: [{ target: "IE", type: "LAND" }, { target: "FR", type: "SEA" }, { target: "BE", type: "SEA" }, { target: "NL", type: "SEA" }], isIsland: true },
