    ...
    return (
        <div class="game-sidebar" style={{
            ...
            <div style={{ "margin-bottom": '2rem' }}>
                <div style={{ "text-transform": 'uppercase', "font-size": '0.75rem', color: '#666', "letter-spacing": '1px' }}>
                    Round {gameStore.round}
                </div>
                <h2 style={{ "font-size": '1.1rem', margin: '0.25rem 0' }}>{gameStore.phase.replace('_', ' ')}</h2>
                <p style={{ "line-height": '1.5', "font-size": '0.95rem', color: '#333' }}>
                    {instructions()}
                </p>
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div style={{ display: 'grid', "grid-template-columns": '1fr auto', gap: '0.25rem', color: '#555' }}>
                                                        <Show when={pVal.journeyCost > 0}><span>Travel Total: -{pVal.journeyCost}€</span></Show>
                                                        <Show when={pVal.space40Cost > 0}><span>Space 40: -{pVal.space40Cost}€</span></Show>
                                                        <Show when={pVal.stackingPenalty > 0}><span>Stacking: -{pVal.stackingPenalty}€</span></Show>
                                                        <Show
                                                            when={pVal.totalEarnings !== undefined}
                                                            fallback={<><span style={{ "font-weight": 'bold' }}>Total Cost:</span> <span style={{ color: '#ef4444', "font-weight": 'bold' }}>-{pVal.totalCost}€</span></>}
                                                        >
                                                            <><span style={{ "font-weight": 'bold' }}>Total Earned:</span> <span style={{ color: '#10b981', "font-weight": 'bold' }}>+{pVal.totalEarnings}€</span></>
                                                        </Show>
                                                    </div>
                                                </div>
                                            );
