...
export function GameEndView() {
    const sortedPlayers = createMemo(() => Object.values(gameStore.players).sort((a, b) => b.money - a.money));
    ...
    return (
        ...
        >
            ...
            >
                <h2 style={{ "text-align": "center", color: "#B45309", "margin-bottom": "1.5rem" }}>Winner: {winner()?.name}</h2>
